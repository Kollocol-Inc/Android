...
private fun validateImageUri(
    ...
    if (mime == null || !mime.startsWith("image/")) {
        return UiText.StringRes(com.ziopam.kollocol.core.ui.R.string.can_select_only_photos)
    }
    ...
    if (size != -1L && size > maxBytes) {
        return UiText.StringRes(com.ziopam.kollocol.core.ui.R.string.file_too_big)
    }
